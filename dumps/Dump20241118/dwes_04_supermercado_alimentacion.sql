...
--
-- Host: 127.0.0.1    Database: dwes_04_supermercado
-- ------------------------------------------------------
...
CREATE TABLE `alimentacion` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `alimentacion_ibfk_1` FOREIGN KEY (`id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
...
INSERT INTO `alimentacion` VALUES (3,12,2024);
