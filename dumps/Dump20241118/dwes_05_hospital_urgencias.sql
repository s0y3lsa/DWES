...
CREATE TABLE `urgencias` (
  ...
  CONSTRAINT `urgencias_ibfk_1` FOREIGN KEY (`medico_codigo`) REFERENCES `medicos` (`codigo`)
...
INSERT INTO `urgencias` VALUES (2,'Unidad de Traumatología'),(3,'Unidad de Cuidados Intensivos');
